import { z } from "zod";
import { SkillTagSchema, PostSkillTagWithoutCategoryBodySchema } from "../skills/skill-tags.schema.js";
...
export const PostSkillCategoryBodySchema = skillCategorySchema.pick({
  name: true
}).extend({
